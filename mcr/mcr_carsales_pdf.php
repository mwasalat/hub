...
$data.='<tr><td style="font-weight:bold;">Vehicle Details</td><td>'.$vehcile_details.'</td></tr>
<tr><td style="font-weight:bold;">Vehicle Category</td><td>'.$vehcile_category.'</td></tr>
...
$pdf->Output($pdf_save, "F");
            $subject       = "MCR CARSALES RECIPT OF $customer - $glcod (MCR NUMBER : $ordervalue)";       
			$title         = "MCR CARSALES RECIPT OF $customer - $glcod (MCR NUMBER : $ordervalue)";       
