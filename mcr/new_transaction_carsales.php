...
if ($refreshflag==3){
	...
	$chasis_no           = killstring($_REQUEST['chasis_no']);
	$model               = killstring($_REQUEST['model']);
	$registration_no     = killstring($_REQUEST['registration_no']);
	$manufacturer        = killstring($_REQUEST['manufacturer']);
	
	$remarks        = killstring($_REQUEST['remarks']);
	
	$vehcile_details   = $fleet_no." | ". $registration_no." | ". $chasis_no;	
    $vehcile_category  = $manufacturer." | ". $model;
	...
	$email_user  = $rowQ[0];
	      ...
	      $sql = "INSERT INTO `tbl_mcr_transactions`( `trans_sl_no`,`location`,`customername`,`customer_phone`, `trans_type`, `emailid`, `chqnumber`,`chqdate`, `bankname`, `model`, `fleet_no`,`chasis_no`,`registration_no`, `manufacturer`, `amount`,`messenger`,`salesmanname`,salesmancode,pscode,glcode,`company`,`mcrstatus`,`remarks`, `type`, `entered_by`,`entered_date`) VALUES ('$ordervalue','$mcr_region','$customer','$phone','$trans_type','$email','$cq_cheque_no',$cq_cheque_date,'$cq_bank','$model','$fleet_no','$chasis_no','$registration_no','$manufacturer','$amount','$email_user','$salmn','$salmnid','$pscode','$glcod','$mcr_company',1,'$remarks',2,'$userno',NOW())";
		  $result  = mysqli_query($conn,$sql); 
		  if($result){
		  include_once("mcr_carsales_pdf.php");	  
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>MCR Carsales - Transaction</h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">MCR Carsales - Transaction</li>
    </ol>
  </section>
  <!-- Main content -->
    ...
    <form role="form" name="company-form" id="company-form" method="post" action="#" enctype="multipart/form-data">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">MCR Carsales - Transaction</h3>
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                <label class="required">Fleet No:</label>
                <input type="text" class="validate[required] form-control" name="fleet_no" id="fleet_no" placeholder="Fleet No"/>
              </div>
              
              <div class="form-group">
                <label class="required">Chasis No:</label>
                <input type="text" class="validate[required] form-control" name="chasis_no" id="chasis_no" placeholder="Chasis No"/>
              </div>
              
              <div class="form-group">
                <label class="required">Model:</label>
                <input type="text" class="validate[required] form-control" name="model" placeholder="Model"/>
              </div>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <input type="text" class="validate[required] form-control" name="registration_no" id="registration_no" placeholder="Registration No"/>
              </div>
              
              
              <div class="form-group">
                <label class="required">Manufacturer:</label>
                <input type="text" class="validate[required] form-control" name="manufacturer" id="manufacturer" placeholder="Manufacturer"/>
              </div>
