...
if ($refreshflag==3){
	...
	if($IsPageValid==true){//valid - true
		  $sql              = "INSERT INTO `tbl_bms_brand_master`(`brand_name`,`is_active`,`entered_by`) VALUES ('$brand_name','$brand_status','$userno')";
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" class="validate[required] form-control" name="brand_name" placeholder="Brand Name"/>
              </div>
              <div class="form-group">
            ...
            <div class="col-md-12">
              <div class="table-responsive">
                <table id="example2" class="table table-bordered table-hover table-striped" role="grid">
                  ...
                  <tbody>
                    <?php 
				                           $sqlQ  = mysqli_query($conn,"SELECT * FROM `tbl_bms_brand_master` ORDER BY `brand_name` ASC");
										   $itr = 0;
                    ...
                    <tr>
                       ...
                       <td><?=$build['brand_name']?></td>
                       <td><div class="status label <?=$label?>"><b><?=$type?></b></div></td>
                       <td><a href="edit_brand_master.php?flag=<?=$build['brand_id']?>&gtoken=<?=$token?>" title="edit"/><i class="fa fa-edit"></i></td>
                    </tr>
                    <?php 
                                            }
                                        ?>
