...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Cheque List -History</h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">Cheque List -History</li>
    </ol>
  </section>
  <!-- Main content -->
    ...
    <form role="form" name="supplier-form" id="supplier-form" method="post" action="#">
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Cheque List -History</h3>
        </div>
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              <div class="table-responsive">
                <table id="example2" class="table table-bordered table-hover table-striped" role="grid" style="font-size:12px;">
                  <thead>
                    <tr>
                      <th >Entry Dt.</th>
                      <th >Batch No.</th>
                      <th >Ref No.</th>
                       <?php if($empid==911855 || $empid==911001 || $empid==911102 || $empid==911300 || $empid==911100 || $empid==300421 || $empid==100205  || $empid==300418){?>
                      <th >Company</th>
                      <?php }?>
                  ...
                  <tbody>
                    <?php 
					                       if($empid==911855 || $empid==911001 || $empid==911102 || $empid==911300 || $empid==911100){//Sanil, Abood, Hashim, Karunesh, Dinesh
