          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="validate[required] form-control" name="route_name" placeholder="Route Name"/>
              </div>
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <input type="text" class="validate[required,custom[number]] form-control" value="0" name="route_amount" placeholder="Route Amount"/>
              </div>
          
            </div>
            <div class="col-md-6">
            <div class="form-group">
                <label class="required">Route Code:</label>
                <input type="text" class="validate[required] form-control" name="route_code" placeholder="Route Code"/>
              </div>
              <div class="form-group">
