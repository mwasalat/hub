...
if ($refreshflag==3){
	...
	if($IsPageValid==true){//valid - true
		  $sql              = "UPDATE `tbl_inv_transactions` SET `status`='$status_now', `cancel_reason`='$cancel_reason',`updated_by`='$userno',`updated_date`=NOW() WHERE `transaction_id`='$transaction_id_now'"; 
