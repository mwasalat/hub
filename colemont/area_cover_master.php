...
if ($refreshflag==3){
	...
	$ac_name            = killstring($_REQUEST['ac_name']);
	$ac_description     = killstring($_REQUEST['ac_description']);
	$IsPageValid = true;	
	if(empty($ac_name)){
	$msg   = "Please enter area of cover name!";
	$IsPageValid = false;
	...
	if($IsPageValid==true){//valid - true
		  $sql              = "INSERT INTO `tbl_cmt_area_of_cover`(`company_id`, `ac_name`, `ac_description`, `entered_by`) VALUES ('$company','$ac_name','$ac_description','$userno')";
		  $result           = mysqli_query($conn,$sql); 
		  if($result){
		  $msg = "Area of cover added successfully";   
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>New Area Of Cover</h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">New Area Of Cover</li>
    </ol>
  </section>
  <!-- Main content -->
    ...
    <form role="form" name="company-form" id="company-form" method="post" action="#" enctype="multipart/form-data">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Area Of Cover</h3>
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label class="required">Area Of Cover Description:</label>
                <textarea class="validate[required] form-control" name="ac_description" placeholder=" Area Of Cover Description"/></textarea>
              </div>
            ...
            <div class="col-md-6">
             ...
             <div class="form-group">
                <label class="required"> Area Of Cover Name:</label>
                <input type="text" class="validate[required] form-control" name="ac_name" placeholder=" Area Of Cover Name"/>
              </div>
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title"> Area Of Cover List</h3>
        </div>
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              <div class="table-responsive">
                <table id="example2" class="table table-bordered table-hover table-striped" role="grid" width="100%;">
                  ...
                  <tbody>
                    <?php 
				                           $sqlQ  = mysqli_query($conn,"SELECT tb1.*,tb2.`company_name` FROM `tbl_cmt_area_of_cover` tb1 LEFT  JOIN `tbl_cmt_ins_company_master` tb2 ON tb1.`company_id`=tb2.`company_id` ORDER BY tb1.`entered_date` DESC");
										   $itr = 0;
