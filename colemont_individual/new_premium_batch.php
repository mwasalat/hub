    ...
    $thumb            = "ENG_".substr($filename, 0, $extension_pos) .'_'.time(). substr($filename, $extension_pos);
	 ...
	 try { 
      ...
      $highestColumn = $sheet->getHighestColumn(); 
				...
				$Query         = mysqli_query($conn,"INSERT INTO `tbl_cmt_ins_price_batch_master` (`tr_no`,`company_id`, `premium_id`, `emirate_id`, `copay_id`, `np_id`,`ac_id`,`start_date`, `end_date`,`batch_name`, `enhanced_maternity`,`wellness_covered`,`dental_covered`,`optical_covered`,`customer_type`, `is_active`,`entered_by`) VALUES ('".$ordervalueA."','".$company_id."','".$premium_id."','".$location_comma_value."','".$copay_id."','".$np_id."','".$ac_id."','".$start_date."','".$end_date."','".$batch_name."','".$enhanced_maternity."','".$wellness_covered."','".$dental_covered."','".$optical_covered."',0,1,'".$userno."')"); 
                ...
                if (!empty($company_id) && !empty($relation_type)) {
					/*****************Start Pricing Mutiple Location*******/
					 ...
					 /*********Price master***/
					 $MyQuery  = mysqli_query($conn,"INSERT INTO `tbl_cmt_ins_price_master` (`tr_no`, `price_batch_id`, `company_id`, `emirate_id`, `copay_id`,`np_id`,`ac_id`, `start_date`, `end_date`, `start_age`, `end_age`,`relation_type`,`gender`,`marital_status`,`price`, `customer_type`, `is_active`,`entered_by`) VALUES ('".$ordervalueA."','".$last_id."','".$company_id."','".$location."','".$copay_id."','".$np_id."','".$ac_id."','".$start_date."','".$end_date."','".$start_age."','".$end_age."','".$relation_type."','".$gender."','".$marital_status."','".$price."',0, 1,'".$userno."')"); 
					 if (empty($MyQuery)) {
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <select class="validate[required] form-control select" name="company" id="company" style="width:100%;" onchange="change_premium(this.value);change_copay(this.value);change_np(this.value);change_ac(this.value);">
              ...
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="start_date" class="validate[required] datepickerA form-control" id="start_date" placeholder="Start Date"/>
                </div>
              </div>
            ...
            <div class="form-group">
                ...
                <div id="ac_select_div">
                  <select class="validate[required] form-control select" name="ac_id" id="ac_id" style="width:100%;">
                  <option selected="selected" value="">---Select an option---</option>
                  </select>
               </div>   
              </div>
            ...
            <div class="col-md-6">
               <div class="form-group">
                ...
                <div id="premium_select_div">
                  <select class="validate[required] form-control select" name="premium_id" id="premium_id" style="width:100%;">
                  <option selected="selected" value="">---Select an option---</option>
                  </select>
               </div>   
              </div>
              <div class="form-group">
                ...
                <div class="input-group date">
                  <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                  <input type="text" name="end_date" class="validate[required] datepickerA form-control" id="end_date"  placeholder="End Date"/>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div id="np_select_div">
                  <select class="validate[required] form-control select" name="np_id" id="np_id" style="width:100%;">
                  <option selected="selected" value="">---Select an option---</option>
                  </select>
               </div>   
              </div>
              ...
              <div class="form-group">
                ...
                <div id="copay_select_div">
                  <select class="validate[required] form-control select" name="copay_id" id="copay_id" style="width:100%;">
                  <option selected="selected" value="">---Select an option---</option>
                  </select>
               </div>   
              </div>
